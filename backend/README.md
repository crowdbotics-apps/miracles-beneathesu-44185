...
## Project Structure
    ...
    ├── miracles_beneathesu_44185  # Django project configurations
...
1. Clone this repo and `cd miracles_beneathesu_44185`
...
2. Clone this repo and `cd miracles_beneathesu_44185`
